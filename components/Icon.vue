<template>
  <div>
    ...
    <!-- home -->
    <svg v-if="icon === 'home'" viewBox="0 0 24 24">
      <g>
        <path
          fill="currentColor"
    ...
    <!-- hastag -->
    <svg v-if="icon === 'hashtag'" viewBox="0 0 24 24">
      <g>
        <path
          fill="currentColor"
    ...
    <!-- bell -->
    <svg v-if="icon === 'bell'" viewBox="0 0 24 24">
      <g>
        <path
          fill="currentColor"
    ...
    <!-- mail -->
    <svg v-if="icon === 'mail'" viewBox="0 0 24 24">
      <g>
        <path
          fill="currentColor"
    ...
    <!-- profile -->
    <svg v-if="icon === 'profile'" viewBox="0 0 24 24">
      <g>
        <path
          fill="currentColor"
    ...
    <!-- more -->
    <svg v-if="icon === 'more'" viewBox="0 0 24 24" fill="currentColor">
      <g>
    ...
    <!-- gif -->
    <svg v-if="icon === 'gif'" viewBox="0 0 24 24">
      <g>
        <path
          fill="currentColor"
    ...
    <!-- image -->
    <svg v-if="icon === 'image'" viewBox="0 0 24 24">
      <g>
        <path
          fill="currentColor"
          d="M19.75 2H4.25C3.01 2 2 3.01 2 4.25v15.5C2 20.99 3.01 22 4.25 22h15.5c1.24 0 2.25-1.01 2.25-2.25V4.25C22 3.01 20.99 2 19.75 2zM4.25 3.5h15.5c.413 0 .75.337.75.75v9.676l-3.858-3.858c-.14-.14-.33-.22-.53-.22h-.003c-.2 0-.393.08-.532.224l-4.317 4.384-1.813-1.806c-.14-.14-.33-.22-.53-.22-.193-.03-.395.08-.535.227L3.5 17.642V4.25c0-.413.337-.75.75-.75zm-.744 16.28l5.418-5.534 6.282 6.254H4.25c-.402 0-.727-.322-.744-.72zm16.244.72h-2.42l-5.007-4.987 3.792-3.85 4.385 4.384v3.703c0 .413-.337.75-.75.75z"
        ></path>
        <circle fill="currentColor" cx="8.868" cy="8.309" r="1.542"></circle>
      </g>
    </svg>
    <!-- chart -->
    <svg v-if="icon === 'chart'" viewBox="0 0 24 24">
      <g>
        <path
          fill="currentColor"
    ...
    <!-- emojis -->
    <svg v-if="icon === 'emojis'" viewBox="0 0 24 24" fill="currentColor">
      <g>
        <path
          d="M12 22.75C6.072 22.75 1.25 17.928 1.25 12S6.072 1.25 12 1.25 22.75 6.072 22.75 12 17.928 22.75 12 22.75zm0-20C6.9 2.75 2.75 6.9 2.75 12S6.9 21.25 12 21.25s9.25-4.15 9.25-9.25S17.1 2.75 12 2.75z"
        ></path>
    ...
    <!-- calendar -->
    <svg v-if="icon === 'calendar'" viewBox="0 0 24 24" fill="currentColor">
      <g>
    ...
    <!-- glow -->
    <svg v-if="icon === 'glow'" viewBox="0 0 24 24">
      <g>
        <path
          fill="currentColor"
