  ...
  <div class="bg-main w-screen h-screen">
    ...
    <div class="w-full h-1/2 relative">
      ...
      <div @click="getBack">
        ...
        <Icon
          icon="leftarrow"
          class="w-6 h-6 absolute text-white top-10 left-4"
        />
      </div>
      <!-- gradient -->
      <div
        class="bg-gradient-to-b from-transparent to-main w-full h-1/2 bottom-0 absolute"
      ></div>
      <!-- image -->
      <img
        :src="
    ...
    <div class="h-full w-full px-5 mt-3">
      <div class="flex justify-between">
        ...
        <div class="flex items-center space-x-3 text-gray-200">
          <Icon icon="add" class="w-8 h-8" />
          <Icon icon="navarrow" class="w-8 h-8 flex items-center" />
        </div>
      </div>
      <div class="mt-5">
